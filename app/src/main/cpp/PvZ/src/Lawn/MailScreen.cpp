...
void MailScreen::Create(LawnApp* theApp) {
    ...
    Sexy_Widget_AddWidget(this, mMailScreenReadButton);
    ...
    Sexy_Widget_AddWidget(this, mMailScreenSwitchButton);
    ...
    Sexy_Widget_AddWidget(this, mMailScreenCloseButton);
...
void MailScreen::RemovedFromManager(int *widgetManager) {
    // 修复MailScreen的可触控区域不为全屏
    Sexy_Widget_RemoveWidget(this, mMailScreenCloseButton);
    Sexy_Widget_RemoveWidget(this, mMailScreenReadButton);
    Sexy_Widget_RemoveWidget(this, mMailScreenSwitchButton);
...
void MailScreen::ButtonDepress(int theId) {
    ...
    MailScreen *aRealMailScreen = (MailScreen *)Sexy_SexyAppBase_GetDialog(mApp, Dialogs::DIALOG_MAIL);
    if (theId == 1002) {
        aRealMailScreen->KeyDown(Sexy::Ok, 0, 0);
    } else if (theId == 1001) {
