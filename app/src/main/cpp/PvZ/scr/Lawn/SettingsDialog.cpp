...
void SettingsDialog_Draw(SettingsDialog *settingsDialog, Sexy::Graphics *graphics) {
    ...
    int holder1[1];
    Sexy_Graphics_SetFont(graphics, *Sexy_FONT_DWARVENTODCRAFT18_Addr);
    Sexy_Graphics_SetColor(graphics, &color1);
    TodStringTranslate(holder1, "[OPTIONS_VIBRATE]");
    Sexy_Graphics_DrawString(graphics, holder1, mVibrateCheckbox->mX + 80, mVibrateCheckbox->mY + 20);
