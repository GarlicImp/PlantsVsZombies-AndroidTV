...
//    homura::HookFunction(LawnApp_HasSeedTypeAddr, &LawnApp_HasSeedType, &old_LawnApp_HasSeedType);
    ...
    homura::HookFunction(Board_AddSunMoneyAddr, &Board_AddSunMoney, &old_Board_AddSunMoney);
    homura::HookFunction(Board_AddDeathMoneyAddr, &Board_AddDeathMoney, &old_Board_AddDeathMoney);
    homura::HookFunction(Board_CanPlantAtAddr, &Board_CanPlantAt, &old_Board_CanPlantAt);
    homura::HookFunction(Board_PlantingRequirementsMetAddr, &Board_PlantingRequirementsMet, &old_Board_PlantingRequirementsMet);
    homura::HookFunction(Board_GetFlowerPotAtAddr, &Board_GetFlowerPotAt, nullptr);
    homura::HookFunction(Board_GetPumpkinAtAddr, &Board_GetPumpkinAt, nullptr);
    homura::HookFunction(Board_ZombiesWonAddr, &Board_ZombiesWon, &old_BoardZombiesWon);
    homura::HookFunction(Board_KeyDownAddr, &Board_KeyDown, &old_Board_KeyDown);
    homura::HookFunction(Board_UpdateSunSpawningAddr, &Board_UpdateSunSpawning, &old_Board_UpdateSunSpawning);
    homura::HookFunction(Board_UpdateZombieSpawningAddr, &Board_UpdateZombieSpawning, &old_Board_UpdateZombieSpawning);
    homura::HookFunction(Board_PickBackgroundAddr, &Board_PickBackground, &old_Board_PickBackground);
    homura::HookFunction(Board_DrawCoverLayerAddr, &Board_DrawCoverLayer, nullptr);
    homura::HookFunction(Board_UpdateGameAddr, &Board_UpdateGame, &old_Board_UpdateGame);
    homura::HookFunction(Board_UpdateGameObjectsAddr, &Board_UpdateGameObjects, &old_Board_UpdateGameObjects);
    homura::HookFunction(Board_IsFlagWaveAddr, &Board_IsFlagWave, &old_Board_IsFlagWave);
    homura::HookFunction(Board_SpawnZombieWaveAddr, &Board_SpawnZombieWave, &old_Board_SpawnZombieWave);
    homura::HookFunction(Board_DrawProgressMeterAddr, &Board_DrawProgressMeter, &old_Board_DrawProgressMeter);
    homura::HookFunction(Board_GetNumWavesPerFlagAddr, &Board_GetNumWavesPerFlag, nullptr);
    ...
    homura::HookFunction(Board_RowCanHaveZombieTypeAddr, &Board_RowCanHaveZombieType, &old_Board_RowCanHaveZombieType);
    homura::HookFunction(Board_DrawDebugTextAddr, &Board_DrawDebugText, &old_Board_DrawDebugText);
    homura::HookFunction(Board_DrawDebugObjectRectsAddr, &Board_DrawDebugObjectRects, &old_Board_DrawDebugObjectRects);
    homura::HookFunction(Board_DrawFadeOutAddr, &Board_DrawFadeOut, nullptr);
    homura::HookFunction(Board_GetCurrentPlantCostAddr, &Board_GetCurrentPlantCost, &old_Board_GetCurrentPlantCost);
    homura::HookFunction(Board_PauseAddr, &Board_Pause, &old_Board_Pause);
    homura::HookFunction(Board_AddSecondPlayerAddr, &Board_AddSecondPlayer, nullptr);
    homura::HookFunction(Board_IsLastStandFinalStageAddr, &Board_IsLastStandFinalStage, nullptr);
    homura::HookFunction(Board_MouseHitTestAddr, &Board_MouseHitTest, &old_Board_MouseHitTest);
    homura::HookFunction(Board_DrawShovelAddr, &Board_DrawShovel, nullptr);
    homura::HookFunction(Board_StageHasPoolAddr, &Board_StageHasPool, nullptr);
    homura::HookFunction(Board_AddZombieInRowAddr, &Board_AddZombieInRow, &old_Board_AddZombieInRow);
    homura::HookFunction(Board_DoPlantingEffectsAddr, &Board_DoPlantingEffects, nullptr);
...
//    homura::HookFunction(Board_GetNumSeedsInBankAddr, &Board::GetNumSeedsInBank, &old_Board_GetNumSeedsInBank);
    ...
    homura::HookFunction(ZombieTypeCanGoInPoolAddr, &ZombieTypeCanGoInPool, &old_ZombieTypeCanGoInPool);
...
inline void InitVTableHookFunction() {
    ...
    homura::HookVirtualFunc(vTableForBoardAddr, 77, &Board_MouseMove, &old_Board_MouseMove);
    homura::HookVirtualFunc(vTableForBoardAddr, 78, &Board_MouseDown, &old_Board_MouseDown);
    homura::HookVirtualFunc(vTableForBoardAddr, 81, &Board_MouseUp, &old_Board_MouseUp);
    homura::HookVirtualFunc(vTableForBoardAddr, 83, &Board_MouseDrag, &old_Board_MouseDrag);
    homura::HookVirtualFunc(vTableForBoardAddr, 133, &Board_ButtonDepress, &old_Board_ButtonDepress);
    ...
    homura::HookVirtualFunc(vTableForMailScreenAddr, 140, &MailScreen_ButtonPress, &old_MailScreen_ButtonPress);
    homura::HookVirtualFunc(vTableForMailScreenAddr, 141, &MailScreen_ButtonDepress, &old_MailScreen_ButtonDepress);
