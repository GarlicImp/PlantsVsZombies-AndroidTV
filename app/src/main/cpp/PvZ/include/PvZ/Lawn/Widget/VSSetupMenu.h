...
public:
    ...
    void GameButtonDown(int theButton, unsigned int thePlayerIndex, int a4) { reinterpret_cast<void (*)(VSSetupMenu *, int, unsigned int, int)>(VSSetupMenu_GameButtonDownAddr)(this, theButton, thePlayerIndex, a4); }
